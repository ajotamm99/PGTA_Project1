...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] data_block_binary = Convert_HexadecimalDataBLock_To_BinaryDataBlock(listaCAT10[0].Get_Data_Block());
            int e = 2;
            e = Get_FSPEC(data_block_binary, e);
            Console.WriteLine("e="+e);
            e = Get_Data_Source_Identifier(data_block_binary, e);
            e = Get_Message_Type(data_block_binary,e);

            if (listaCAT10[0].FSPEC_char[0] == '1') { i = listaCAT10[0].Get_Message_Type(data_block_binary, i); }
